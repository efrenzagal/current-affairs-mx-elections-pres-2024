"""Fetch the official current LXVI Senado roster.
...
Run from the repository root::
    ...
    python3 camara_de_senadores/composicion/crawl_senadores_roster.py
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fetch current official Senado roster")
