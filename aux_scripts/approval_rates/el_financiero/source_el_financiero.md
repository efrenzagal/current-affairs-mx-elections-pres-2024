...
- **`Revisiones al T-MEC`, 2026-07** — not loaded. The "Muy bien/Bien" point is
  drawn on the 2026-07 chart but carries **no printed label** (the "Mal/Muy
  mal" value, 40, is printed). Per rule 1, not transcribed. Recoverable if a
  later wave restates it.
...
- Last wave loaded: **2026-07** (67 / 33), from the article published
  2026-08-03
- Headline series continuous from 2024-10
- 2026-01 → 2026-06 are `grafica+grafica`; 2026-07 is `grafica` until the next
  wave restates it
