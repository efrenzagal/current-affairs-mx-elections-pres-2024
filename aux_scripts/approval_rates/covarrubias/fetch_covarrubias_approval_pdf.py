"""Fetch one Covarrubias approval-report PDF for manual transcription.

This helper saves a direct PDF for visual inspection and never extracts chart
values automatically.

Usage:
    /usr/bin/python3 aux_scripts/approval_rates/covarrubias/fetch_covarrubias_approval_pdf.py URL
"""
...
def main() -> None:
    ...
    parser.add_argument("url", help="Direct Covarrubias PDF URL")
